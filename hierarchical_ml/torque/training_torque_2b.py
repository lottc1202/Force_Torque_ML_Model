...
def saving_models(eph,fold_ind,mdl,optmzr,schdlr,mdl_type='_torque_2b'):
...
for fld_i in range(opt.k_fold):
    ...
    mdl_2b = trq_2b(lyr_wdt=opt.lyr_wdt,
    ...
    for epoch in range(opt.n_epochs):
        ...
        for i,datas in enumerate(dataloader):
            ...
            """
            # Loss
            loss_2b = criterion_loss(w_lft*wgt*fake,w_lft*wgt*real)
        ...
        if (cur_val>=prev_val) and (prev_val > mean_scheduler):
            ...
            if (val_cnt >= 50) and (epoch > 99):
                saving_models(epoch+1,fld_i,mdl_2b,optimizer_2b,
                              scheduler_2b,mdl_type='_torque_2b')
                break
