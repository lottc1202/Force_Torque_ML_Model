...
parser.add_argument("--num_lyrs",type=int,default=5,help="number of layer in model")
parser.add_argument("--lyr_wdt",type=int,default=150,help="width of each layer")
...
n_xyz = torch.as_tensor([[[0.0,1.1,0.0]]],device=device)
...
thisdict = {'fake':fk_np,'xyz':xyz_np,
            'n_xyz':n_xyz_np,
            'inpts':invar_np}
sio.savemat("trinary_trq_inflc_map_"+opt.fl_tag
             +".mat",thisdict)
